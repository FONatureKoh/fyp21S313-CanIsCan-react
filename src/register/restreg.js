  ...
  return (
    <div className="App">
        <header className="App-header">
          ...
          <input type="text" name="username" placeholder="Restaurant Name " ref= {username} />
          <input type="text" name="uen" placeholder="Restaurant Business UEN " ref= {uen_num} />
          <input type="text" name="email" placeholder="Restaurant Email" ref= {email} />
